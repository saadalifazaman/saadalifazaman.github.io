...
<p>Selected coursework directly relevant to my research. For full course descriptions, see 
<a href="https://name.buet.ac.bd/undergraduate-courses" target="_blank">NAME's official undergraduate course catalog</a>:</p> 
...
* **Undergraduate Thesis**, BUET Final Grade: A+ (4.00/4.00) (June 2023–July 2024)
  ...
  * Collected and curated the Narayanganj Dockyard Biofouling Dataset (NDBD) from Dockyard & Engineering Works LTD, Narayanganj (CC BY-NC 4.0 license, publicly available on GitHub). Then trained YOLOv8 segmentation variants (transfer learning) to detect and localize biofouling and steel-corrosion defects using video/images (fouling F1 up to 0.90), producing a real-time detection prototype for automated hull inspection. Funded by [RISE](https://rise.buet.ac.bd/#/) Student Research Grant.
