...
excerpt: "Independently collected and curated the first publicly available ship hull biofouling dataset from Dockyard & Engineering Works Ltd., Narayanganj an active industrial dockyard in Bangladesh. 35 high-resolution images, 92 annotated instances, CC BY-NC 4.0 license, foundational to two subsequent research projects.<br/><img src='/images/ndbd-sample-annotations.gif'>"
